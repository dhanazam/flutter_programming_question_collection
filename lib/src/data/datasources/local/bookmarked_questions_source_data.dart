...
class BookmarkedQuestionsSourceDataImpl
    implements BookmarkedQuestionsSourceData {
  ...
  @override
  Future<List<Question>> getBookmarkedQuestionsByCategory(
      String categoryName) async {
    final category =
        _cacheService.bookmarkedQuestionsCategories.get(categoryName);
